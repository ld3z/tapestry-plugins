...
const LANGUAGE_CODE = "es_419"; // *** UPDATED Language Code ***
...
function load() {
	...
	const apiLangCode = LANGUAGE_CODE.replace('_', '-');
	...
	.then((text) => {
		...
		for (const chapterData of chapters) {
			try {
				...
				// --- Set Body ---
				// *** Use language identifier in the link text ***
...
function verify() {
	...
	.then((text) => {
		...
		const verification = {
			displayName: "Comick API (AR)", // *** Update display name ***
